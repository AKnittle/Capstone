...
# ROC and AUC graphs
rocByLibrary(rfCancer_t100f5, logDustData, logDustData$CASESTAT, type="prob")

```

[I found this nifty cross validation function here that does proportional Cross Validation (ie. cross validate on 10%) which I'll use here](https://www.rdocumentation.org/packages/rfUtilities/versions/2.1-5/topics/rf.crossValidation)
...
rf.cv <- rf.crossValidation(rfCancer_t100f5, train_DustData, p=0.10, n=10)
