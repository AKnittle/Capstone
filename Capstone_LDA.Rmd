...
# errorRateTable.test <- lda.k.fold.validator2(train_DustData, "CASESTAT", 10)
# errorRateTable.test
# test.predValues <-as.numeric(as.character(predict(lda.fit, train_DustData)$class))
# 
# rawConfusionBuilder(train_DustData$CASESTAT, test.predValues)
