...
[To find the optimal bias we want to use Gradient Descent](https://youtu.be/IN2XmBhILt4?t=515), and that means we need to take the derivative of the SSR with respect to bias. Because the SSR are linked to bias by the predicted values the Chain Rule can be applied to solve for the derivative of the SSR with respect to bias.
